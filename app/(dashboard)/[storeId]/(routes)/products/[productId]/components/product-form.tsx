...
const formSchema = z.object({
  name: z.string().min(1),
  //*this how you include images in your z schema
  images: z.object({ url: z.string() }).array(),
  // coerce is added because we using a decimal in prisma
...
//?importing not only product but images as well...
  ...
  return (
    <>
      ...
      <Form {...form}>
        ...
        >
          <FormField
            //! Image uploader is not uploading multiple image. Problem needs resolving
